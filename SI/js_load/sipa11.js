	  ...
	  $(".thinputrhpa199tbl_1").change( function () {
	    ...
	    $("#sipa11_tbl_1_filter").hide();
          ...
          $(".selectchs").chosen({width: "300px"});
			 
			 
			 $("#pantallitasweb").on("submit", function(e){
				
                 e.preventDefault();				
				 
				 var dataString = $(this).serialize()+"&action=pantallasweb";
